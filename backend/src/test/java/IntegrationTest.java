...
//import org.kybartas.transaction.Statement;
...
//
//        registry.add("application.datasource.url", postgres::getJdbcUrl);
//        registry.add("application.datasource.username", postgres::getUsername);
//        registry.add("application.datasource.password", postgres::getPassword);
//        registry.add("application.jpa.hibernate.ddl-auto", () -> "update");
//    }
//
//    @Test
//    @Order(1)
...
//            assertNotNull(statement.getAccountNumber(), "transaction should have account number");
//            assertNotNull(statement.getAmount(), "transaction should have amount");
//            assertNotNull(statement.getType(), "transaction should have type");
//            assertNotNull(statement.getBeneficiary(), "transaction should have beneficiary");
//            assertNotNull(statement.getDate(), "transaction should have date");
//            assertNotNull(statement.getCurrency(), "transaction should have currency");
//        }
//    }
//
